...
Machine learning model that predicts diseases using medical symptoms and patient data.
...
A task management web app with authentication and CRUD operations.
